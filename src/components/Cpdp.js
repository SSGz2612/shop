...
// styled
import {
    BBCenterCardClient, BodyBoxCardClient, BoxLR, BoxNR,
    BtnVCC, BtnVCCFalse, CardBoxViewClient, ContainerBoxTx,
    ContainerBoxVC, ContainerViewClient, Header, ImgViewCLMin,
    InfoTextTittle, ImgViewClient, TxTittle, TxTittle3, BoxLRModalInput, TxTittle2, BoxLR2
...
class Cpdp extends React.Component {
    ...
    handleImg = ( i, id ) => {
        ...
        // console.log( this.props.updImg[0][1] );
        // console.log( this.props.selProduct[0].id === this.props.updImg[0][1] );
    }
    ...
    <CardBoxViewClient>
        ...
        <ContainerViewClient>
            <ImgViewClient url={ this.props.updImg[0] === null ? this.props.selProduct[0].gallery[0] : this.props.updImg[0]}>
            </ImgViewClient>
            ...
            <BoxLR><BtnVCC onClick={ this.addToBasket }><b>ADD TO CARD</b></BtnVCC></BoxLR> :
